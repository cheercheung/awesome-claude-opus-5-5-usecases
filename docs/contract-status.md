...
| Area | Current result |
|---|---|
| GitHub repository surface | README-first collection; no standalone website |
| Cases | 208 selected cases; nine duplicate/follow-up entries merged, four insufficient-evidence entries held out |
